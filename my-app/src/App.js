  ...
  render() {
    ...
    return (
      <div className="page-setup">
        <div className="title"> Celebrity Gossip App </div>
        <div className="info"> This app will display top celebrities and allow you to access written articles involving them, as well as the positivity/negativity percentages of recent articles published by them. TBD on how recent the info pulled will come from </div>
        <div className="info"> How it works: If the score next to each article is less than 0.65, then the article was mainly negative. If it is greater than 0.65, then the article is mainly positive. </div>
        <div> Influencers: </div>
        ...
        <div className="results"> Results for <div className="b-name">{celeb}</div></div>
        ...
        <div className="group">
          ...
          <div className="group-1">
            <div>Summary:</div>
            <div className="group-1-content">
              <div> Percent Positive Articles:
          <div className="pos"> {percentPositive}</div>
              </div>
              <div> Percent Negative Articles:
          <div className="neg"> {percentNegative}</div> </div>
          ...
          <ul>
            {titles.map((value, index) => {
              return <li key={index}> <a href={value[0][1]}> {value[0][0]}</a>, Score: {scores[value[0][0]]}</li>
            })}
          </ul>
        </div>
        ...
        <div className="group">
          <hr></hr>
          <div className="group-title">Youtube Comments</div>
          <hr></hr>
          <div className="group-1">
            <div>Summary:</div>
            <div className="group-1-content">
              <div> Percent Positive Comments:
          <div className="pos"> {commentPositive}</div>
              </div>
              <div> Percent Negative Comments:
          <div className="neg"> {commentNegative}</div> </div>
